	...
	return (
		<>
			<Head>
				...
				<meta name='twitter:site' content='https://bloodrunning.com' />
				<meta name='twitter:creator' content='@deadunicorninc' />
				<meta
					name='description'
					key='description'
					content=''
				...
				<meta
					name='og:image'
					key='og-image'
					content='https://bloodrunning.com/1200x630.jpg'
				/>
				<meta
					name='og:url'
					key='og-url'
					content='https://bloodrunning.com'
				/>
				<meta
					name='twitter:title'
					key='twitter-title'
				...
				<meta
					name='twitter:image'
					key='twitter-image'
					content='https://bloodrunning.com/1024x512.jpg'
				/>
			</Head>
